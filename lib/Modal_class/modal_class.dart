...
//
//   factory SongModal.fromJson(Map<String, dynamic> m1) {
...
//
//   factory Data.fromJson(Map<String, dynamic> m1) {
//     return Data(
...
//   });
//
//   factory Result.fromJson(Map<String, dynamic> m1) {
//     return Result(
//         id: m1['id'] ?? null,
//         name: m1['name']?? null,
//         label: m1['label'] ?? null,
//         url: m1['url'] ?? null,
//         duration: m1['duration'] ?? null,
...
//
//   factory Artists.fromJson(Map<String, dynamic> m1) {
...
//       required this.image});
//
//   factory Primary.fromJson(Map<String, dynamic> m1) {
//     return Primary(
//         id: m1['id'],
//         name: m1['name'],
//         url: m1['url'],
...
//
//   factory Img.fromJson(Map<String, dynamic> m1) {
...
//
//   factory Album.fromJson(Map<String, dynamic> m1) {
//     return Album(
//       id: m1['id'],
//       name: m1['name'],
//       url: m1['url'],
